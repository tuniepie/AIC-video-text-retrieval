...
app = FastAPI()
app.mount("/static", StaticFiles(directory="/home/hoangtv/Desktop/Attention/Nguyen/utils/static"), name="static")
templates = Jinja2Templates(directory="/home/hoangtv/Desktop/Attention/Nguyen/utils/templates")
...
async def search(search_request: SearchRequest):
    while True:
        ...
        shortened_path, images_id = format_for_CSV(image_paths,images_id)

        destination_folder = "/home/hoangtv/Desktop/Attention/Nguyen/utils/static/images"
...
# async def relatedKeyFrames(image_keyframe: ImageKeyFrame):
#     received_image_keyframe = image_keyframe.imageKeyFrame
...
if __name__ == '__main__':
    import uvicorn
    uvicorn.run(app, host='127.0.0.1', port=8281, debug=True)

# run: cd /home/hoangtv/Desktop/Attention/Truong/utils
# uvicorn blip_processing:app --host 127.0.0.1 --port 8282 --reload
